...
// GET: Obtener citas del usuario (como solicitante o como agente)
...
// PUT: Confirmar cita (solo agente)
...
// GET: Obtener horarios disponibles de un agente para un día específico
app.get('/api/appointments/available-slots/:agentId', authenticateToken, async (req, res) => {
  try {
...
// PUT: Reprogramar una cita existente (cambiar fecha/hora)
